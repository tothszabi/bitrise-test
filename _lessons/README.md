...
- The first step was a simple command to make sure we have what it takes to start our adventures: `curl -L https://github.com/tothszabi/bitrise-test/v2/releases/download/VERSION/bitrise-$(uname -s)-$(uname -m) > /usr/local/bin/bitrise`
